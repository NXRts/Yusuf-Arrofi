  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-20 p-2 rounded-xl bg-surface-container-high/90 hover:bg-surface-bright text-on-surface-variant hover:text-white border border-surface-variant backdrop-blur-md transition-all shadow-md cursor-pointer"
        ...
        <div className="p-5 md:p-7 pb-0">
          <div className="w-full aspect-video rounded-xl md:rounded-2xl overflow-hidden bg-surface-container-lowest border border-surface-variant/80 relative shadow-inner">
            ...
            />
            <div className="absolute top-3 left-3 px-3 py-1 rounded-lg bg-surface-elevated/90 border border-surface-variant font-mono text-xs font-semibold text-secondary uppercase tracking-wider backdrop-blur-xs">
              {project.category}
            </div>
          </div>
        </div>
        ...
        <div className="p-5 md:p-7 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-1.5 pr-8">
            ...
            <h2 
              ...
              className="font-sans text-2xl md:text-3xl font-extrabold text-text-primary tracking-tight"
            >
              {project.title}
            </h2>
          </div>
          ...
          {project.metrics && (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2.5 p-3.5 rounded-xl bg-surface-container-low border border-surface-variant/60 font-mono text-xs">
          ...
          <div className="pt-5 border-t border-surface-variant/60 flex flex-wrap items-center justify-between gap-3 mt-2">
            <button
              onClick={onClose}
              className="px-4 py-2.5 rounded-xl border border-surface-variant bg-surface-container-low hover:bg-surface-container-high text-xs font-mono text-on-surface-variant hover:text-white transition-colors cursor-pointer"
            >
              Close
            </button>
            ...
            <div className="flex items-center gap-3">
              {project.github && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-surface-variant bg-surface-container-high hover:bg-surface-bright text-xs font-mono font-semibold text-text-primary hover:text-white transition-all shadow-sm"
                >
              ...
              {project.link && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-secondary hover:bg-secondary/90 text-surface font-mono text-xs font-bold transition-all shadow-lg shadow-secondary/20 hover:shadow-secondary/30"
                >
                  <span>Live App</span>
