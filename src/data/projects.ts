...
export const projectsData: Project[] = [
  {
    ...
    fullDescription: "JapanApp is an interactive, modern web application specifically engineered for mastering Japanese characters (Kanji, Hiragana, Katakana) and JLPT N5 through N1 vocabulary. It combines interactive stroke-order animations, mnemonic memory aids, real-time Jisho API integration, and an intelligent Spaced Repetition System (SRS) that optimizes learning retention for long-term fluency.",
    features: [
    ...
    description: "Official web platform for Prameswari EO Kemuning, featuring interactive tour package catalogs (Outbound 1-6, 9 Jeep Safari Routes, River Tubing Kali Pucung), direct WhatsApp booking integration, responsive gallery, and modern tourism management UI.",
    fullDescription: "Prameswari EO is a modern, responsive web application engineered for the official event organizer and adventure tour operator in Kebun Teh Kemuning, Karanganyar. The platform showcases 6 tiered corporate outbound packages, 9 offroad jeep safari routes with detailed itineraries, real-time search and filter controls, client testimonials, and automated direct WhatsApp reservation dispatch.",
    features: [
    ...
    category: "fullstack",
    featured: true,
    tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Lucide Icons", "Vercel"],
    metrics: {
  ...
  },
  {
    ...
    fullDescription: "Aria2App is a sleek, cross-platform graphical user interface for the ultra-fast aria2c command-line multi-connection download utility. Built using Python and PyQt6, it communicates via JSON-RPC to monitor active downloads, manage segmented transfer queues, configure proxy settings, and maximize bandwidth utilization.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "Periodik is an interactive chemistry web application providing an exploratory periodic table of the chemical elements. Built with pure modern web technologies, it features real-time search, chemical families filtering, detailed atomic properties, electron orbital configurations, and electronegativity scales with an eye-catching cyberpunk/neon aesthetic.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A dual-pane live Markdown editor and previewer built with Next.js and React. Offers real-time split-screen rendering, customizable syntax themes via Highlight.js, GitHub-flavored markdown extensions, word/character statistics, and instant export to HTML or raw markdown.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "Smart Compressor is a private, client-side image compression tool that operates entirely within the user's browser using HTML5 Canvas and Web APIs. It allows users to shrink images drastically while preserving optimal visual fidelity, featuring interactive before-and-after sliders and batch conversion capabilities.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "RemoveBG is a high-performance background removal web utility tailored for designers and content creators. It utilizes edge-optimized background segmentation pipelines to cleanly isolate subjects from complex backgrounds while preserving full HD and 4K image sharpness.",
    features: [
  ...
  },
  {
    ...
    category: "tools",
    featured: false,
    tags: ["Next.js 14", "TypeScript", "Tailwind CSS", "HTML5 Audio", "Lucide React"],
    metrics: {
  ...
  },
  {
    ...
    fullDescription: "Music Mee is a sleek web-based audio streaming application engineered with React and the HTML5 Web Audio API. It features real-time canvas frequency visualizers, persistent playlist curation, track queueing, audio gain controls, and smooth playback transitions in a futuristic neon atmosphere.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "Backend microservice for Simaku E-Learning platform, engineered in Golang with PostgreSQL following Clean Architecture (Domain-Driven Design). Handles user authentication with JWT, course curriculum management, student-teacher assignments, grade reporting, and role-based access controls.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "High-concurrency event registration and digital guestbook API service designed in Go and PostgreSQL. Built to withstand sudden bursts of event check-in traffic, maintaining sub-15ms response times with connection pooling and prepared statements.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A minimalist Pomodoro technique timer built with vanilla web technologies. Supports standard 25/5 focus and break cycles, custom interval adjustments, audio bell alerts, and daily productivity streak counters stored locally.",
    features: [
  ...
  },
  {
    ...
    fullDescription: "A retro block-stacking arcade puzzle game built using Flutter and Dart. Designed with a custom grid rendering engine, standard Tetromino rotation mechanics, line clearing animations, score multipliers, and adaptable controls for mobile and desktop screens.",
    features: [
